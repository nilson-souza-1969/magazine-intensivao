...
export function inicializarCarrinho() {
    ...
    const botaoIrParaCheckout = document.getElementById('btn-finalizar-compra');
...
function incrementarQuantidadeProduto(idProduto) {
    ...
    atualizarPrecoCarrinho(idElement);
...
function desenharProdutoNoCarrinho(idProduto) {
    const produto = catalogo.find((p) => p.id === Number(idProduto));
...
//         precoTotalCarrinho +=
//             catalogo.find((p) => p.id === Number(idProdutoNoCarrinho)).preco *
...
export function atualizarPrecoCarrinho(idElement) {
    const precoCarrinho = document.getElementById(idElement);
